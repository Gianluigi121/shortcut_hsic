...
def compute_loss_weighted(labels, logits, embedding, params):
...
def eval_step(model, x, y, params):
    ...
    # loss
    eval_pred_loss, eval_hsic_loss = compute_loss_weighted(y, logits, zpred, params)
...
if __name__ == '__main__':
    ...
    plt.savefig(MAIN_DIR + f'plot_w/train_loss_epoch{epoch_num}_l2{l2}.png')
    ...
    plt.savefig(MAIN_DIR + f'plot_w/train_acc_epoch{epoch_num}_l2{l2}.png')
    ...
    plt.savefig(MAIN_DIR + f'plot_w/train_auroc_epoch{epoch_num}_l2{l2}.png')
    ...
    plt.savefig(MAIN_DIR + f'plot_w/val_loss_epoch{epoch_num}_l2{l2}.png')
    ...
    plt.savefig(MAIN_DIR + f'plot_w/val_acc_epoch{epoch_num}_l2{l2}.png')
    ...
    plt.savefig(MAIN_DIR + f'plot_w/val_auroc_epoch{epoch_num}_l2{l2}.png')