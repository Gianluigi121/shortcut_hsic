...
FOLDER_DIR = '/nfs/turbo/coe-rbg/zhengji/age_shortcut/'
df = pd.read_csv(FOLDER_DIR + 'penumonia_nofinding_cohort.csv')
...
new_df.to_csv(FOLDER_DIR + 'final_pen_nofinding_cohort.csv', index=False)
