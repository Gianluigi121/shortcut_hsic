...
#
# copied from '''https://github.com/mikevoets/jama16-retina-replication/blob/
# 15f2af375c5a581a2002f346efc9a72f4b47f667/lib/preprocess.py#L1'''
...
if __name__ == "__main__":
	resize_and_center_fundus(
		save_path='/data/ddmg/scate/dr/images_processed',
		images_path='/data/ddmg/scate/dr/images',
		image_paths=None,
		image_path=None,
		diameter=299,
		verbosity=1)
